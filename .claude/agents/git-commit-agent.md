...
2. Follow the specific commit message guidelines defined in `.agents/commit-message.instructions.md`
...
- STRICTLY adhere to all guidelines in `.agents/commit-message.instructions.md`
