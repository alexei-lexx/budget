# Feature Specification: Weekday Expense Report Outlier Filtering
...
### User Story 1 - Filter Outliers from Weekday Averages (Priority: P1)
...
- **UI Feedback**: The checkbox label will be "Exclude outliers from averages" unless user testing suggests a clearer alternative.
...
- **Income Transactions**: Outlier filtering applies only to expense transactions, not income or transfer transactions.
