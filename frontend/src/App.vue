...
<template>
  <v-layout class="rounded rounded-md border">
    ...
    <v-main class="d-flex align-center justify-center" height="300">
      <v-container>
        <v-sheet border="dashed md" color="surface-light" height="200" rounded="lg" width="100%" class="d-flex flex-column align-center justify-center">
          ...
          <div v-else-if="error" class="text-center">
            ...
            <v-btn @click="refetch()" color="primary" variant="outlined">
              Retry Connection
            </v-btn>
          </div>
