...
The system SHALL close any open category form dialog when the user presses Escape,
...
- GIVEN a category form dialog is open and an input field has focus
- WHEN the user presses Escape
- THEN the dialog closes and the categories page is shown

#### Scenario: Escape closes the dialog after an outside-click attempt

- GIVEN a category form dialog is open
