...
Describes support for configuring an optional custom domain for the frontend application, including HTTPS enforcement, authentication compatibility, URL discoverability, and setup documentation.
